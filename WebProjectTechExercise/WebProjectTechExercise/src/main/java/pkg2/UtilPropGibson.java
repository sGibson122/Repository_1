...
public class UtilPropGibson {
   static final boolean _W = System.getProperty("os.name").toLowerCase().contains("windows");
   static String _PROP_FILENAME_WIN_LOCAL = "C:\\Users\\shima\\workspace4830\\workspace4830-techExcercise-gibson\\WebProjectTechExercise\\src\\main\\webapp\\config.properties";
   static String _PROP_FILENAME_OSX_LOCAL = "/YOUR_PATH/WebProjectTechExercise/WebContent/config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat9/webapps/WebProjectTechExercise/config.properties";
