...
public class UtilPropUsers {
   static final boolean _W = System.getProperty("os.name").toLowerCase().contains("windows");
   static String _PROP_FILENAME_WIN_LOCAL = "C:\\Users\\shima\\workspace4830\\workspace4830-EveryTable\\EveryTable\\src\\main\\configUsers.propertiess";
   static String _PROP_FILENAME_OSX_LOCAL = "/YOUR_PATH/EveryTable/WebContent/configUsers.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat9/webapps/EveryTable/configUsers.properties";
